...
class PlanesController {
    ...
    {
        $categoria = isset($_GET['categoria']) ? $_GET['categoria'] : ''; // Obtener la categoría desde la URL
        $ciudad = isset($_GET['ciudad']) ? $_GET['ciudad'] : 1; // Obtener la ciudad desde la URL, con valor por defecto
        $search = isset($_GET['search']) ? $_GET['search'] : ''; // Obtener el término de búsqueda desde la URL
